...
public class MemoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pagerMemory = (ViewPager) v.findViewById(R.id.pagerMemory);
        tabDotsMemory = (TabLayout) v.findViewById(R.id.tabDotsMemory);

        TabViewPagerAdapter adapter = new TabViewPagerAdapter(getActivity().getSupportFragmentManager());
        adapter.addFragment(new MemoryTabItemFragment(), "");
        adapter.addFragment(new MemoryTabItemFragment(), "");
        adapter.addFragment(new MemoryTabItemFragment(), "");
...
//        tabDotsMemory.getTabAt(0).select();
        return v;
    }
